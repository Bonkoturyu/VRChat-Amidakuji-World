...
- **あみだ密度プリセット(疎/標準/密)**(2026-06-24 追加) — Master がエントリーエリア UI で横線生成の重み比を切替え、レース時間と運要素の濃さを調整する。§4.1 / [ADR-0002](./docs/adr/0002-deterministic-rng-seed-sync.md) の重み付き 5 パターン抽選の重み比を差し替えるのみで実装可。v1.1 候補「カート速度設定」とは別軸で相補
