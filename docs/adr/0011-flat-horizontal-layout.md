...
- 床: 単一の大型 Mesh(Cube Scale 16 × 0.2 × 80 m、GoalBarrier 4 連の全幅 16 m と整合)、上面 Y=0
- 縦線(4 本): 細い Cube(0.2 m 幅 × 0.02 m 高 × 60 m 長)を床上面に貼り付け、X=-6/-2/+2/+6
- 横線(最大 **33 本** = 11 段 × 3 隣接ペア): 細い Cube(4.0 m 幅 × 0.02 m 高 × 0.2 m 長)、隣接縦線ペアの境界 Z に配置、enable/disable でランダム表示
...
- 全ての線は単一マテリアル `M_Line`(白 `#FFFFFF`)で描画。Mobile Tri 数への影響は微小
  (最大 37 本 = 縦 4 + 横 33、× Cube 12 tris = 444 tris、バジェット 250,000 の 0.2%)
